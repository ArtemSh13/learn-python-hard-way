...
class CentralCorridor(Scene):
    ...
    def enter(self) -> Literal['death'] | Literal['laser_weapon_armory'] | Literal['central_corridor']:
        print(dedent("""
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self) -> Literal['the_bridge'] | Literal['death']:
        print(dedent("""
...
class TheBridge(Scene):
    ...
    def enter(self) -> Literal['death'] | Literal['escape_pod'] | Literal['the_bridge']:
        print(dedent("""
...
class EscapePod(Scene):
    ...
    def enter(self) -> Literal['death'] | Literal['finished']:
        print(dedent("""
...
class Finished(Scene):
    ...
    def enter(self) -> Literal['finished']:
...
class Map(object):
    ...
    def next_scene(self, scene_name: str) -> Scene:
        val: Scene | None = Map.scenes.get(scene_name)
        if val is None:
            raise Exception("There is no scene with that name.")
        return val
...
class Engine(object):
    ...
    def play(self) -> None:
        current_scene: Scene = self.scene_map.opening_scene()
